...
const FooterSection = () => {
  ...
  return (
    <footer>
      <div className='mt-5 py-10 w-full bg-bodyColor mx-auto flex justify-center items-center flex-col border-t-2  border-gray-500 '>
      ...
      <div className='flex my-10 justify-between gap-10 text-3xl '>
     <a href="https://www.messenger.com/t/100075532211635" target='blank'> <FaFacebookMessenger  className='text-[#dd00ff]'/></a>
      ...
      <a href="https://www.linkedin.com/in/manisha-pariyar-22b1a5253/" target='blank'><FaLinkedin className='text-[#00b7fff1]' /></a>
       ...
       <div className="flex justify-center items-center mt-3 text-[16px]  text-white font-playfair font-bold py-5  rounded-sm">{text}</div>
      </div>
      <a href="/home" className="items-end justify-end flex "><FaArrowCircleUp className="text-3xl text-designColor" /></a>
    </footer>
  )
}
